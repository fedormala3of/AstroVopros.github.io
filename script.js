...
function initBottomNavigation() {
    ...
    if (navShop) {
        navShop.addEventListener('click', () => {
            ...
            showSection(shopSection, navShop);
        });
    }
    ...
    if (navReadings) {
        navReadings.addEventListener('click', () => {
            ...
            showSection(mainSection, navReadings);
        });
    }
    ...
    if (navCabinet) {
        navCabinet.addEventListener('click', () => {
            ...
            showSection(cabinetSection, navCabinet);
        });
    }
...
function startMiniGame(gameType) {
    ...
    if (!miniGamesSection) {
        console.error('Секция мини-игр не найдена');
        return;
    }
    
    // Скрываем все секции и показываем секцию мини-игр
...
function showGameMenu() {
    ...
    // Возвращаемся к главной секции
    const mainSection = document.querySelector('.main');
    if (mainSection) {
        mainSection.style.display = 'block';
    }
    
    // Активируем кнопку гаданий
    const navReadings = document.getElementById('navReadings');
    if (navReadings) {
        document.querySelectorAll('.nav-item').forEach(btn => btn.classList.remove('active'));
        navReadings.classList.add('active');
    }
}
