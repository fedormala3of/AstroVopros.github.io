...
function addEventListeners() {
    ...
    // Кнопки статистики
    document.getElementById('viewStatsBtn').addEventListener('click', showAdStats);
    document.getElementById('exportStatsBtn').addEventListener('click', exportStats);
    document.getElementById('resetStatsBtn').addEventListener('click', resetStats);
    document.getElementById('backToEarnBtn').addEventListener('click', showEarnCoinsSection);
