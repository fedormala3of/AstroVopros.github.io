...
const config = {
    ...
    webAppUrl: 'https://your-domain.com', // URL вашего мини-приложения
...
bot.onText(/\/start/, (msg) => {
    ...
    // Создаем inline keyboard с кнопкой мини-аппа
    const keyboard = {
        inline_keyboard: [
            [{
                text: '🔮 Открыть мини-приложение',
                web_app: { url: 'https://localhost:3443/' }
            }]
        ]
    };
...
module.exports = { bot, tarotCards, spreads, userData };
